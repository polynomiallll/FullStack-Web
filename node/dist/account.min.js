...
class Account {
  ...
  async login() {
    this.getData();
    await axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/user-api").then(res => {
  ...
  async signup() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/user-api", {
      data: {
